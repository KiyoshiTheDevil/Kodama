...
export function AccountSettingsTab({ accounts, activeAccount, onSwitch, onAdd, onReauth, onRemove, onRename, onLogout, onAvatarChange, hideUserHandle, onToggleHideUserHandle }) {
  const t = useLang();
  const list = accounts || [];
