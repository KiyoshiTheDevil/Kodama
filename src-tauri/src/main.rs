...
use audio::{AudioPlayer, start_audio_thread, audio_play, audio_crossfade, audio_pause, audio_resume, audio_stop, audio_seek, audio_set_volume, audio_set_levels_enabled, audio_set_eq, audio_outputs, audio_set_output};
use discord::{DiscordRpc, disconnect_rpc, update_discord_rpc, clear_discord_rpc};
use window::{FullscreenState, set_fullscreen, open_login_window, close_login_window, remove_window_border_for, lock_square_for, ensure_session_keeper, rotate_session_cookies, stop_session_keeper};
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            audio_outputs, audio_set_output,
